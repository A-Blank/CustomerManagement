...
<s:form action="update" method="post" namespace="/">
    <table border="0" align="center" width="40%" style="margin-left: 100px">
     	<tr>
            <td width="100px">客户编号</td>
            <td width="40%">
                <input id="uid" type="text" readonly="readonly" name="uid" value="${ model.uid }" />
            </td>
        </tr>
        <tr>
            <td width="100px">客户名称</td>
            <td width="40%">
                <input id="username" type="text" name="username" value="${ model.username }" />
            </td>
        </tr>
       <tr>
        ...
        <tr>
            ...
            <td>
                 <input id="birthday" type="text" name="birthday" value="<s:date name="model.birthday" format="yyyy-MM-dd" />" />
            </td>
        </tr>
        <tr>
            <td>描述</td>
            <td width="300px" align="center">
                <textarea rows="5" cols="17" name="description"><s:property value="model.description"/></textarea>
            </td>
